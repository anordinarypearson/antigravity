...
export const SUBSCRIPTION_LIMITS: Record<SubscriptionTier, UsageLimits> = {
    free: {
        ...
        pdfUploadsPerDay: 2,
        pdfUploadsPerMonth: 10,
        webScrapesPerDay: 5,
        youtubeExtractionsPerDay: 5,
        mindMapsPerDay: 3,
        presentationsPerDay: 2,
        questionPapersPerDay: 3,
        codeAnalysisPerDay: 5,
        imageSearchesPerDay: 10,
        webSearchAIPerDay: 10,
    },
    go: {
